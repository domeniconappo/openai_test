...
def test_update_prompt(
    api_client: APIClient, existing_prompt: Prompt, mock_openai: None
) -> None:
    update_data = {"text": "Updated Prompt Text"}
    update_response = {
        "text": "Updated Prompt Text",
        "response": "Response Test Prompt Text",
    }
    ...
    assert existing_prompt.response == update_response["response"]
